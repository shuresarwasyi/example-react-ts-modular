  ...
  return (
    <section className="bg-white dark:bg-gray-900 antialiased">
      <div className="max-w-screen-xxl px-4 py-8 mx-auto lg:px-6 sm:py-16 lg:py-24">
        ...
        {members.length > 0 ? (
          <div className="grid grid-cols-1 gap-8 mt-8 lg:mt-16 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4">
            {members.map((member) => (
              <div
                key={member.id}
          ...
          <div className="mt-12 text-center">
            <div role="status">
              <svg
                aria-hidden="true"
                className="inline w-8 h-8 mr-2 text-gray-200 animate-spin dark:text-gray-600 fill-purple-700"
                viewBox="0 0 100 101"
                fill="none"
